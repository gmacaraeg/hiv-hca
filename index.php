        ...
        <div class="modal-body">
                <form role="form" method="POST" id = "myform3">
                    ...
                    <label class="control-label">Mobile Number</label>
                        <div>
                            <input type="text" class="form-control input-lg" name="contact" placeholder="Mobile Number" maxlength="13" value="" required>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="control-label">Position</label>
                      <select class = "form-control block"  name = "position">

                      <option value = "HACT-Admin" name = "position">HACT-Admin</option>
                      <option value = "HACT-Nurse" name = "position">HACT-Nurse</option>
                      <option value = "HACT-Healthworker" name = "position">HACT-Healthworker</option>
