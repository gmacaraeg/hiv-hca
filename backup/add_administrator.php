...
if (isset($_POST['add_accnt_btn'])) {
    ...
    $result = itexmo($recipient_num, $message,$apicode, $apipass);
        ...
        $sql_add = "INSERT INTO tbl_admin  ( full_name,contact_number, position, account_type, account_created, account_code) VALUES ( '$fname','$contact', '$position', '$account_type' , '$date','$account_code')";
